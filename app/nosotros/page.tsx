        ...
        <div className="bg-white">
            ...
            <section className="relative h-[600px] flex items-center justify-center text-center text-white">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-4">
                    <h1 className="text-4xl md:text-6xl font-heading mb-4">Sobre Nosotros</h1>
                </div>
            </section>
            ...
            <main className="container mx-auto px-4 py-16">
                <div className="max-w-7xl mx-auto space-y-24">
                    ...
                    <section className="bg-light-bg p-6 rounded-lg">
                        <h3 className="text-2xl font-heading mb-6 text-dark-gray">
                            Nuestra Historia
                        </h3>
                    ...
                    <section className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="flex flex-col items-center text-center">
                            <Warehouse className="w-12 h-12 text-red-primary mb-4" />
                            <h4 className="text-lg font-heading mb-2">Amplia Gama</h4>
                            <p className="text-foreground">
                                Ofrecemos una extensa selección de maquinaria para todas las necesidades agrícolas.
                            </p>
                        </div>
                        <div className="flex flex-col items-center text-center">
                            <Users className="w-12 h-12 text-red-primary mb-4" />
                            <h4 className="text-lg font-heading mb-2">Atención Personalizada</h4>
                            <p className="text-foreground">
                                Nuestro equipo de expertos brinda asesoramiento técnico y soporte continuo.
                            </p>
                        </div>
                        <div className="flex flex-col items-center text-center">
                            <Award className="w-12 h-12 text-red-primary mb-4" />
                            <h4 className="text-lg font-heading mb-2">Calidad Garantizada</h4>
                            <p className="text-foreground">
                    ...
                    <section className="mb-16">
                        <h3 className="text-2xl font-heading text-center mb-8 text-dark-gray">Entrevistas Destacadas</h3>
                        <YouTubeCarousel />
                    </section>
